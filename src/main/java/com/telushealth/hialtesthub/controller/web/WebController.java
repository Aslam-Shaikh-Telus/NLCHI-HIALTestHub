package com.telushealth.hialtesthub.controller.web;
...
//	}
	...
	@GetMapping("/getloadtestdetails")
	public String getLoadTestDetails(@RequestParam("startTime") String startTime, Model model) {
		LoadTestResult loadTestResult = loadTestResultService.findTestResultByStartTime(startTime);
		model.addAttribute("loadTestResult", loadTestResult);
		
//		List<SoapTransaction> soapTransactions = soapTransactionService.findAllSoapTransactionsByStartTime(startTime);
//		model.addAttribute("soapTransactions", soapTransactions);
		return "loadtest_transactions";
	}
	...
	@GetMapping("/testCase")
	public String showTestCase(@RequestParam("interactionId") String interactionId, Model model) {
		// Retrieve testCase with the specified interactionId (you need to implement this
		// method)
