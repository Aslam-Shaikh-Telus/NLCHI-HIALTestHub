...
//	}
	...
	@GetMapping("/getLoadTestTransactions")
	public List<SoapTransaction> getLoadTestTransactionsByStartTime(@RequestParam("startTime") String startTime) {
		return soapTransactionService.findAllSoapTransactionsByStartTime(startTime);
	}
}
